...
pub struct Accelerate {
    pub accel_degree: f32, // acceleration constant
}

impl Accelerate {
    pub fn new_entity(entity: Entity, accel_degree: f32) -> Entity {
        Entity {
            ...
            accel_degree, // acceleration constant
        }
    }
}
...
mod tests {
    ...
    fn test_create_entity() {
        ...
        let ent3: Entity = Accelerate::new_entity(ent2, 2.0);
        assert_eq!(ent3.accel_degree, 2.0);
